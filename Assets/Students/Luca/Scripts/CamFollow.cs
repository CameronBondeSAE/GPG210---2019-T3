...
namespace Students.Luca
{
    public class CamFollow : MonoBehaviour
    {
        ...
        public float
            maxFollowSpeedDistance =
                10; // When cam is this dist away from the desired location, it travels at full speed
        ...
        private void MoveToDesiredPosition()
        {
            ...
            {
                float followSpeed =
                    (Mathf.Clamp(distanceToDesiredPos, 0, maxFollowSpeedDistance) / maxFollowSpeedDistance) *
                    maxFollowSpeed;
        ...
        private void SmoothLookAtTarget()
        {
            ...
            float actualRotationSpeed =
                (Mathf.Clamp(remainingAngle, 0, maxRotationSpeedAngle) / maxRotationSpeedAngle) * maxRotationSpeed;
