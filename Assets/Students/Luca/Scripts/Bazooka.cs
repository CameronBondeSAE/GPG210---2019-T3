    ...
    public class Bazooka : MonoBehaviour
    {
        ...
        private void ShootProjectile()
        {
            ...
            projectileObj.transform.rotation =
                Quaternion.LookRotation(projectileExitVector.forward); //projectileExitVector.rotation;
            ...
            projectile.rb.AddForceAtPosition(projectileObj.transform.forward * fireStrength, forcePosition,
                ForceMode.Impulse);
