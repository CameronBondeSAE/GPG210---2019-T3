...
namespace Students.Luca.Scripts
{
    public class BuoyantBody : MonoBehaviour
    {
        ...
        private class Triangle
        {
            ...
            public Triangle(Vector3 pV1, Vector3 pV2, Vector3 pV3, Water currentClothWater)
            {
                v1 = pV1;
                v2 = pV2;
                v3 = pV3;
                ...
                distUnderWater = currentClothWater.GetSurfaceLevelAtPos(centroid.x, centroid.z) - centroid.y;
        ...
        private void CalculateUnderWaterAreas()
        {
            ...
            var waterEntering = currentWater.GetSurfaceLevelAtPos(waterPosition.x, waterPosition.z) >= waterEntryLevelY;
            ...
            for (var i = 0; i < triangles.Length; i+=3)
            {
                ...
                var waterHeight = currentWater.GetSurfaceLevelAtPos(areaCenterWorldPos.x, areaCenterWorldPos.z);
                ...
                if (distanceUnderWater > 0)
                {
                    ...
                    if (!hasWaterEntryLevel || (waterEntering || areaNormalWorld.y <= 0)) // TODO Hack: This ignores inside-faces of a "regular shaped" boat. Super Hacky.
                    {
